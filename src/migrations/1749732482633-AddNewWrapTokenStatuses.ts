...
export class AddNewWrapTokenStatuses1749732482633 implements MigrationInterface {
    name = 'AddNewWrapTokenStatuses1749732482633'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TYPE "public"."wrap_token_audits_fromstatus_enum" AS ENUM('created', 'tokens_sent', 'tokens_received', 'tokens_received_with_mismatch', 'creating_safe_transaction', 'safe_transaction_created', 'signing_safe_transaction', 'safe_transaction_signed', 'executing_safe_transaction', 'safe_transaction_executed', 'timeout')`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TYPE "public"."wrap_token_transactions_status_enum_old" AS ENUM('created', 'tokens_sent', 'tokens_received', 'tokens_received_with_mismatch', 'creating_safe_transaction', 'safe_transaction_created', 'executing_safe_transaction', 'safe_transaction_executed', 'timeout')`);
        await queryRunner.query(`ALTER TABLE "wrap_token_transactions" ALTER COLUMN "status" DROP DEFAULT`);
        ...
        await queryRunner.query(`CREATE TYPE "public"."wrap_token_audits_tostatus_enum_old" AS ENUM('created', 'tokens_sent', 'tokens_received', 'tokens_received_with_mismatch', 'creating_safe_transaction', 'safe_transaction_created', 'executing_safe_transaction', 'safe_transaction_executed', 'timeout')`);
        ...
        await queryRunner.query(`CREATE TYPE "public"."wrap_token_audits_fromstatus_enum_old" AS ENUM('created', 'tokens_sent', 'tokens_received', 'tokens_received_with_mismatch', 'creating_safe_transaction', 'safe_transaction_created', 'executing_safe_transaction', 'safe_transaction_executed', 'timeout')`);
