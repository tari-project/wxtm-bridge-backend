...
export class AddNewWrapTokenStatuses1749732482633
  implements MigrationInterface
{
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TYPE "public"."wrap_token_audits_fromstatus_enum" AS ENUM('created', 'tokens_sent', 'tokens_received', 'tokens_received_with_mismatch', 'creating_safe_transaction', 'safe_transaction_created', 'signing_safe_transaction', 'safe_transaction_signed', 'executing_safe_transaction', 'safe_transaction_executed', 'timeout')`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TYPE "public"."wrap_token_audits_tostatus_enum" AS ENUM('created', 'tokens_sent', 'tokens_received', 'tokens_received_with_mismatch', 'creating_safe_transaction', 'safe_transaction_created', 'signing_safe_transaction', 'safe_transaction_signed', 'executing_safe_transaction', 'safe_transaction_executed', 'timeout')`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TYPE "public"."wrap_token_transactions_status_enum" AS ENUM('created', 'tokens_sent', 'tokens_received', 'tokens_received_with_mismatch', 'creating_safe_transaction', 'safe_transaction_created', 'signing_safe_transaction', 'safe_transaction_signed', 'executing_safe_transaction', 'safe_transaction_executed', 'timeout')`,
    );
    await queryRunner.query(
