...
export class UpdateWrapToken1755078203584 implements MigrationInterface {
  name = 'UpdateWrapToken1755078203584';
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `CREATE TYPE "public"."wrap_token_transactions_status_enum_old" AS ENUM('created', 'tokens_sent', 'tokens_received', 'tokens_received_with_mismatch', 'creating_safe_transaction', 'creating_safe_transaction_unprocessable', 'safe_transaction_created', 'executing_safe_transaction', 'safe_transaction_unprocessable', 'safe_transaction_executed', 'timeout', 'mining_tokens_received_below_min_amount', 'mining_incorect_payment_id', 'mining_incorect_payment_id_and_amount', 'mining_incorrect_payment_id', 'mining_incorrect_payment_id_and_amount')`,
    );
    await queryRunner.query(
      `ALTER TABLE "wrap_token_transactions" ALTER COLUMN "status" DROP DEFAULT`,
    );
