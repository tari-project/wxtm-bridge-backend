...
export class UpdateTokenWrapTransactions1747661936713
  implements MigrationInterface
{
  name = 'UpdateTokenWrapTransactions1747661936713';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TYPE "public"."wrap_token_transactions_status_enum" AS ENUM('created', 'tokens_sent', 'tokens_received', 'creating_safe_transaction', 'safe_transaction_created', 'unprocessable')`,
    );
    await queryRunner.query(
