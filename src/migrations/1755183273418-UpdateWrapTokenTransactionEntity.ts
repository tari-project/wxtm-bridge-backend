...
export class UpdateWrapTokenTransactionEntity1755183273418
  implements MigrationInterface
{
  name = 'UpdateWrapTokenTransactionEntity1755183273418';

  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE "wrap_token_transactions" ADD "transactionId" integer`,
    );
    await queryRunner.query(
      `ALTER TYPE "public"."wrap_token_audits_fromstatus_enum" RENAME TO "wrap_token_audits_fromstatus_enum_old"`,
    );
    await queryRunner.query(
      `CREATE TYPE "public"."wrap_token_audits_fromstatus_enum" AS ENUM('created', 'tokens_sent', 'tokens_received', 'tokens_received_aggregated', 'replaced_by_aggregated', 'tokens_received_with_mismatch', 'creating_safe_transaction', 'creating_safe_transaction_unprocessable', 'safe_transaction_created', 'executing_safe_transaction', 'safe_transaction_unprocessable', 'safe_transaction_executed', 'timeout', 'mining_tokens_received_below_min_amount', 'mining_incorrect_payment_id', 'mining_incorrect_payment_id_and_amount')`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TYPE "public"."wrap_token_audits_tostatus_enum" AS ENUM('created', 'tokens_sent', 'tokens_received', 'tokens_received_aggregated', 'replaced_by_aggregated', 'tokens_received_with_mismatch', 'creating_safe_transaction', 'creating_safe_transaction_unprocessable', 'safe_transaction_created', 'executing_safe_transaction', 'safe_transaction_unprocessable', 'safe_transaction_executed', 'timeout', 'mining_tokens_received_below_min_amount', 'mining_incorrect_payment_id', 'mining_incorrect_payment_id_and_amount')`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TYPE "public"."wrap_token_transactions_status_enum" AS ENUM('created', 'tokens_sent', 'tokens_received', 'tokens_received_aggregated', 'replaced_by_aggregated', 'tokens_received_with_mismatch', 'creating_safe_transaction', 'creating_safe_transaction_unprocessable', 'safe_transaction_created', 'executing_safe_transaction', 'safe_transaction_unprocessable', 'safe_transaction_executed', 'timeout', 'mining_tokens_received_below_min_amount', 'mining_incorrect_payment_id', 'mining_incorrect_payment_id_and_amount')`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "wrap_token_transactions" ADD CONSTRAINT "FK_e669532042c5aec10857f733b74" FOREIGN KEY ("transactionId") REFERENCES "wrap_token_transactions"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
  }

  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE "wrap_token_transactions" DROP CONSTRAINT "FK_e669532042c5aec10857f733b74"`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "wrap_token_transactions" DROP COLUMN "transactionId"`,
    );
  }
}
